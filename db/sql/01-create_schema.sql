...
CREATE TABLE IF NOT EXISTS Settings (
    ...
    "base_theme" VARCHAR(12) DEFAULT 'light',
    "passcode" TEXT NULL,
    ...
    "color_light" INTEGER DEFAULT -1,
    "color_accent" INTEGER DEFAULT -10011977,
    "global_color_theme" VARCHAR(12) NULL DEFAULT 'default',
    "message_timestamp" BOOLEAN DEFAULT false,
    "subscription_type" INTEGER DEFAULT 3,
    "subscription_expiration" BIGINT DEFAULT 1600789518254,
...
BEGIN
    ...
    INSERT INTO UnifiedPush ("push_url", "push_app_token", "account_id") VALUES ('gotify1.unifiedpush.org', 'testtoken', accountId);
